...
import { heroImages } from "@/lib/portfolio-data"
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-12 text-white">
            <div className="container mx-auto">
              <h2 className="font-serif text-5xl md:text-7xl font-light mb-4 text-balance">{image.title}</h2>
              <p className="text-lg md:text-xl text-white/90 tracking-wide">{image.location}</p>
            </div>
          </div>
        </div>
      ))}
